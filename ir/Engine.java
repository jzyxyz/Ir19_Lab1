...
public class Engine {
    ...
    /**
     * Constructor. Indexes all chosen directories and files
     */
    public Engine(String[] args) {
         ...
         * index is synchronized since we don't want to search at the same time we're
         * indexing new files (this might corrupt the index).
         */
        if (is_indexing) {
